...
int get_last_max_index(int array[], int size) {
	int index = 0;
...
int get_last_min_index(int array[], int size) {
	int index = 0;
...
void swap_extrem_elements(int array[], int size) {
	...
	int index_max = get_last_max_index(array, size);
	int index_min = get_last_min_index(array, size);
